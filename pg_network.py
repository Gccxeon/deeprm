...
class PGLearner:
    def __init__(self, pa):
        ...
        print('network_input_height={}'.format(pa.network_input_height))
        print('network_input_width={}'.format(pa.network_input_width))
        print('network_output_dim={}'.format(pa.network_output_dim))
        ...
        print(' params={}, count={}'.format(params, lasagne.layers.count_params(self.l_out)))
        ...
        print('lr_rate={}'.format(self.lr_rate))
